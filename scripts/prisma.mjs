...
const command=process.platform==='win32'?'pnpm.cmd':'pnpm';const result=spawnSync(command,['--filter','@lfinfo/backend','exec','prisma',...process.argv.slice(2),'--schema','prisma/schema.prisma'],{cwd:root,stdio:'inherit',env:process.env});process.exit(result.status??1);